    ...
    <>
      ...
      <div className="device">
        <div className="topbar">
          ...
          <div className="avatar" onClick={goStats} title="Ver estadísticas (rol: bibliotecaria)">
            📊
          </div>
        </div>

        {/* LOGIN */}
        <div className={`screen ${currentScreen === "login" ? "active" : ""}`} id="s-login">
          ...
          <div className="login-box">
            ...
            <div className="campo">
              ...
              <input type="text" defaultValue="24-0138" readOnly />
            </div>
            <div className="campo">
              <label>Contraseña</label>
              <input type="password" defaultValue="12345678" readOnly />
            </div>
